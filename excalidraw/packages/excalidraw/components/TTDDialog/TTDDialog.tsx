...
export const TTDDialogBase = withInternalFallback(
  ...
  ({
    ...
    const [diagramType, setDiagramType] = useState("flowchart"); // NEW STATE
    ...
    const onGenerate = async () => {
      ...
      try {
        ...
        try {
          ...
          setError(
            new Error(
              "Generated an invalid diagram :(. Try a different prompt.",
            ),
          );
        }
      } catch (error: any) {
          ...
          {!("__fallback" in rest) && (
            <TTDDialogTab className="ttd-dialog-content" tab="text-to-diagram">
              <div className="ttd-dialog-desc">
                Use the dropdown to select the diagram type (flowchart,
                sequence, class, ER, pie, etc.) and describe what you want.
              </div>
              <TTDDialogPanels>
                <TTDDialogPanel
                ...
                >
                  ...
                  <div style={{ marginBottom: "8px" }}>
                    ...
                    >
                      <option value="flowchart-horizontal">Flowchart</option>
